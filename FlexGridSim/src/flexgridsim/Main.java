...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("le minload est  " + minload);
		System.out.println("le maxload est  " + maxload);
		System.out.println("le step  est  " + step);
		simConfigFile = args[0];
		seed = Integer.parseInt(args[1]);

		System.out.println("fffffffff"+simConfigFile);
