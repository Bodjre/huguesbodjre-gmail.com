    ...
    public void Execute(String simConfigFile, boolean trace, boolean verbose, double forcedLoad, int numberOfSimulations) {
        ...
        try {
	        ...
	        if (!doc.getDocumentElement().hasAttribute("version")) {
	            System.out.println("Cannot find version attribute!");//lit version debut fichier deuxieme
	            System.exit(0);
	        }
	        ...
	        for (int seed = 1; seed <= numberOfSimulations; seed++) {
	            ...
	            if (Simulator.verbose) {
	             ...
	             //  wg=pt.getWeightedGraph();
	               
	                // System.out.println("affichage du graph"+wg);
	            	
	               System.out.println("topologie physique\n"+pt);
	            ...
	            if (Simulator.verbose) {
	                ...
	                System.out.println("topologie virtuelle\n"+vt);
	            }
